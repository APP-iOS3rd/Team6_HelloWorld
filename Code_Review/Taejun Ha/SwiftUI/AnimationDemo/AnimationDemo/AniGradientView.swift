...
/*
 - 애니메이션이 시작되면 gradient 시작점을 왼쪽 상단에서 왼쪽 하단으로 변경하고,
 종료점을 오른쪽 하단에서 오른쪽 상단으로 변경
...
//        AnimatableModifierGradientView()
    }
}

// MARK: - AnimatableModifier를 사용하여 Gradient에 애니메이션을 적용
// - 테마 같은거 설정할 때 사용하는거임

struct AnimatableModifierGradientView: View {
...
// MARK: -
// 시작점과 끝점을 변경하여 Gradient에 애니메이션 적용
